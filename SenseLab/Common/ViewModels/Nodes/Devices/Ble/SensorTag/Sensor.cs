...
namespace SenseLab.Common.ViewModels.Nodes.Devices.Ble.SensorTag
{
    ...
    {
        public Sensor(string serviceUuid, string configUuid, string dataUuid)
        {
        ...
        public event EventHandler<ValueChangeEventArgs<byte[]>> ValueChanged;
        ...
        protected string ServiceUuid { get; private set; }
        protected string ConfigUuid { get; private set; }
        protected string DataUuid { get; private set; }
        protected GattDeviceService DeviceService { get; private set; }
        ...
        public async Task<bool> Initialize()
        {
            ...
            DeviceService = await GetDeviceService();
        ...
        public async Task<bool> Initialize(DeviceInformation deviceInfo)
        {
            ...
            if (!deviceInfo.Id.Contains(ServiceUuid))
